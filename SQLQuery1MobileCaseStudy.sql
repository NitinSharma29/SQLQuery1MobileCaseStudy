---create a database db_SQLCaseStudies
create database db_SQLCaseStudies

--- use db_SQLCaseStudies Database
use db_SQLCaseStudies

--- create a table with column IdManufacturer, Manufacturer_Name with name DIM_MANUFACTURER
create table DIM_MANUFACTURER (
IDManufacturer int primary key identity (11, 1),
Manufacturer_Name VARCHAR (20)
)
--- create a table with column IdModel, Model_Name, Unit_Price, IdManufacturer with name DIM_MODEL
...
--- create a table with column IdCustomer, Customer_Name, Email, Phone with name DIM_CUSTOMER
...
---create a table with column IdLocation, ZipCode, Country, [State], City with name DIM_LOCATION
...
--- create a table with column [Date], [Year], [Quater], [Month] with name DIM_DATE
...
--- create table with column IdModel, IdCustomer, IdLocation, Date, TotalPrice, Quantity with name FACT_TRANSACTIONS
...
--- insert the data in table DIM_MANUFACTURER
insert into DIM_MANUFACTURER (Manufacturer_Name)
values ('Apple')

---insert the data in table DIM_MODEL
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('iPhone 4', 377, '11') 
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('iPhone 4S', 414, '11')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('iPhone 5', 456, '11')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('iPhone 6', 501, '11')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('iPhone 7', 552, '11')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('Thunderbolt', 201, '16')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('C139', 121, '15')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('C200', 148, '15')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('Droid Bionic', 155, '15')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('RAZR V3', 81, '15')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('Motorola Z', 283, '15')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('3210', 14, '14')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('5230', 31, '14')
...
values ('6600', 47, '14')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('3310 (3330)', 28, '14')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('6010 (6020/6030)', 55, '14')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('6230 (6233)', 52, '14')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('E1100', 148, '12')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('E250', 168, '12')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('Galaxy Note II', 216, '12')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('Galaxy S', 175, '12')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('Galaxy S4', 283, '12')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('Galaxy S5', 391, '12')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('Galaxy S7', 432, '12')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('Galaxy S8', 662, '12')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('OnePlus X', 168, '13')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('OnePlus 2', 189, '13')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('OnePlus 5', 317, '13')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('OnePlus 5T', 405, '13')
insert into DIM_MODEL (Model_Name, Unit_Price, IdManufacturer)
values ('OnePlus 6T', 495, '13')

---insert the data in table DIM_CUSTOMER
insert into DIM_CUSTOMER (Customer_Name, Email, Phone)
values ('Kallie Blackwood', 'kallie.blackwood@abc.com', '4159170276'), 
('Johnetta Abdallah', 'johnetta_abdallah@abc.com', '9196014934'), 
('Bobbye Rhym', 'brhym@abc.com', '6505905578')
insert into DIM_CUSTOMER (Customer_Name, Email, Phone)
values ('Micaela Rhymes', 'micaela_rhymes@abc.com', '9251192329'), 
...
---insert the data in table DIM_LOCATION
INSERT INTO DIM_LOCATION (ZipCode, Country, [State], City) 
VALUES (85086, 'US', 'Arizona', 'Anthem'), 
...
---insert the data in table DIM_DATE
INSERT INTO DIM_DATE ([DATE])
VALUES ('02/15/2005'), ('10/23/2005'), ('02/26/2003'), ('05/25/2009'), ('04/16/2003'), ('11/03/2003'), 
...
---insert the data in table FACT_TRANSACTIONS
INSERT INTO FACT_TRANSACTIONS (IDModel, IDCustomer, IDLocation, Date, TotalPrice, Quantity)
VALUES (114, 10015, 2001, '02/15/2005', 52, 1), 
...
---Q1 States in which we have customers who had bought cellphones from 2005 till to now.
select [State],DATE 
from DIM_LOCATION,FACT_TRANSACTIONS 
where [Date] >= '2005'
order by Date asc 

---Q2 What state in US is buying more 'Samsung' cell phones ?

select top 1 DIM_LOCATION.Country,FACT_TRANSACTIONS.Quantity, DIM_LOCATION.State, FACT_TRANSACTIONS.IDLocation, DIM_MODEL.IDModel, DIM_MANUFACTURER.Manufacturer_Name 
from DIM_LOCATION
...
--- Q3 Show the number of transactions for each model per each zip code per state.

select Model_Name, count(*) as Num_of_Trans from FACT_TRANSACTIONS right join DIM_MODEL on FACT_TRANSACTIONS.IDModel=DIM_MODEL.IDModel
where DIM_MODEL.IDModel=FACT_TRANSACTIONS.IDModel group by Model_Name
union all
select [State], count(*) as  Num_of_Trans from DIM_LOCATION right join FACT_TRANSACTIONS on DIM_LOCATION.IDLocation=FACT_TRANSACTIONS.IDLocation
where FACT_TRANSACTIONS.IDLocation>DIM_LOCATION.IDLocation group by [State]

--- Q4 Show the cheapest CellPhone.

select top 1 Manufacturer_Name, Model_Name, Unit_price  from DIM_MANUFACTURER, DIM_MODEL
where DIM_MODEL.IDManufacturer=DIM_MANUFACTURER.IDManufacturer order by Unit_price asc

--- Q5 Find out the average price for the each model in the top 5 manufacturers in terms of sales quality and order by average price.

select top 5 Manufacturer_Name, avg(TotalPrice) Avg_Rate, sum(Quantity) Sale_Quality
from FACT_TRANSACTIONS T1 left join DIM_MODEL M1 on T1.IDModel=M1.IDModel inner join DIM_MANUFACTURER M2
on M1.IDManufacturer=M2.IDManufacturer
group by Manufacturer_Name
order by Sale_Quality desc

--- Q6 List the name of the customers and the average amount spent in 2009, where the average is higher than the 500.

select Customer_Name , [YEAR], avg(TotalPrice) as Amt_Spent
from DIM_CUSTOMER, DIM_DATE,FACT_TRANSACTIONS
where [YEAR]=2009 and TotalPrice >500 and  FACT_TRANSACTIONS.IDCustomer=DIM_CUSTOMER.IDCustomer 
group by Customer_Name, [YEAR]
order by Amt_Spent

--- Q7 List if there is model that was in the top 5 in therms of quantity, simultaneously in 2008, 2009, 2010.
...
GROUP BY IDModel
HAVING COUNT(*) = 3 
select IDModel, Model_Name from DIM_MODEL where IDModel=109

--- Q8 Show the manufacturer with the 2nd top sales in the year 2009 and the manufacturer with the 2nd top sale in the year of 2010.

SELECT  top 1 * from(SELECT TOP 2 Manufacturer_name,
SUM(Quantity )  TQ1 FROM Fact_Transactions T1 LEFT JOIN DIM_Model D1 ON T1.IDModel = D1.IDModel
...
(SELECT Top 2 Manufacturer_name,SUM(Quantity ) TQ2 FROM Fact_Transactions T2 LEFT JOIN DIM_Model DM ON T2.IDModel = DM.IDModel
...
--- Q9 Show the manufacturer that sold cellphone in 2010 but did'nt 2009.

select a.IDManufacturer, a.Manufacturer_Name
from DIM_MANUFACTURER as a 
where exists 
(select 1 from DIM_MODEL d ,FACT_TRANSACTIONS f
where (a.IDManufacturer=d.IDManufacturer) and (d.IDModel=f.IDModel) and f.Date>= '2010-01-01' and f.Date< '2011-01-01') and
not exists (select 1 from DIM_MODEL d ,FACT_TRANSACTIONS f
where (a.IDManufacturer=d.IDManufacturer) and (d.IDModel=f.IDModel) and f.Date>= '2009-01-01' and f.Date< '2010-01-01')


--- Q10 Find the top 100 customers and their average spend, average quality by each year, Also find the percentage of thei change in spend.

use [db_SQLCaseStudies]
go
declare @top_amount int = 4;

select Customer_Name, avg(TotalPrice) as Avg_Spend, avg(Quantity) as Avg_Quantity, year(Date) as [Year],
ROW_NUMBER() over(partition by Year(Date)
order by avg(TotalPrice) desc) as rn
into All_Customers 
from DIM_CUSTOMER as c inner join FACT_TRANSACTIONS as t on c.IDCustomer = t.IDCustomer
group by Customer_Name, Year(Date)

select L.Customer_Name, L.Year, L.Avg_Spend, L.rn,
R.Year as [Next_Year], R.Avg_Spend , R.rn as [Next_rn],
1.0 * R.Avg_Spend / L.Avg_Spend - 1.0 as diff
from All_Customers as L left join All_Customers as R
on L.Customer_Name = R.Customer_Name
and R.[Year]=L.[Year] + 1 
select top 100 * from All_Customers 
